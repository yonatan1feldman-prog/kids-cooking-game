...
MOM_LINES = {
    ...
    "vo-guest-who": "Who's coming to eat with us?",
    "vo-pipa-brought": "Pipa brought a friend!",
    "vo-guest-giraffe": "Look, Giraffe is here!",
    "vo-guest-turtle": "Look, Turtle is here!",
    "vo-guest-penguin": "Look, Penguin is here!",
    "vo-for-giraffe": "Some for Giraffe!",
    "vo-for-turtle": "Some for Turtle!",
    "vo-for-penguin": "Some for Penguin!",
    "vo-giraffe-loves": "Giraffe loves green food!",
    "vo-turtle-loves": "Turtle loves it!",
    "vo-penguin-loves": "Penguin loves it!",
    "vo-turtle-nap": "Shh! Turtle is having a little nap.",
