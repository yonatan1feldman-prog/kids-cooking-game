  ...
  steps: [
    ...
    },
    {
      ...
      params: {
        ...
        mitts: { pair: 'oven-mitts', single: 'mitt-single', line: 'vo-mitts', pull: 'vo-pull-out' },
      },
    },
    {
      type: 'share',
      params: { slice: 'pizza-slice', slices: TUNING.share.slices, cut: { knife: 'knife', line: 'vo-cut-slices' }, line: 'vo-share', forMom: 'vo-slice-mom', momYum: 'vo-mom-yum', forPet: 'vo-slice-pipa' },
    },
