...
## Handoff notes (written for the next agent; gameplay round 4 (cutting, challenges), visual round 5 (more around the kitchen), visual round 4 (the living window), the puzzle, gameplay round 3, the final QA round, the guests round, gameplay round 2, round 14 (polish) and round 13 (skewers) on top; rounds 2-12 below still hold)
### 00000000000000000. Gameplay round 4 (cutting that follows the finger; a new small challenge in every recipe)
