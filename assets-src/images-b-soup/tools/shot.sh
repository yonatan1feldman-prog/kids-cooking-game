#!/bin/bash
# One screenshot at a time (images-b-soup), file:// only (no HTTP server): needs >= 2048 MB free RAM
...
# usage: tools/shot.sh <out.png> <page?query relative to images-b-soup/> [cssW cssH dpr]
