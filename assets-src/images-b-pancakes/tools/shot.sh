#!/bin/bash
# One screenshot at a time (images-b-pancakes), file:// only (no HTTP server): needs >= 2048 MB free RAM
...
# usage: tools/shot.sh <out.png> <page?query relative to images-b-pancakes/> [cssW cssH dpr]
